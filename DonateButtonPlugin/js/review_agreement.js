      ...
      */
        ...
        */
        ...
        async function getPublications() {
            try {
                await fetch(server + path + '/plugins/generic/DonateButtonPlugin/request/publications.php?type=getDataBySubmissionId&submissionId=' + reviewerAssignmentData.submission_id)
